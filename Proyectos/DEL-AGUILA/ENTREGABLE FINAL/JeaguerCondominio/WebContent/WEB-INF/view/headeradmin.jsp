					...
					<ul class="nav navbar-nav navbar-left">
						<li><a id="home" href="administrador.htm">INICIO</a></li>
							...
							<ul class="dropdown-menu">
								...
								<li><a href="registroinmueble.htm"> Inmueble</a></li>
								<li><a href="registraralquiler.htm"> Alquiler Auditorio</a></li>
								<li><a href="registrorecibo.htm"> Recibo Agua</a></li>
								<li><a href="javascript: fnLoadPage('obliManten.htm');"> Cuota Mantenimiento</a></li>
							</ul></li>
						<li class="dropdown"><a href="#" class="dropdown-toggle"
							...
							<ul class="dropdown-menu">
								...
								<li><a href="listarecibos.htm"> Recibo de Agua</a></li>
							</ul></li>
					</ul>
				</div>
				<!--End::Nav--> </header>
