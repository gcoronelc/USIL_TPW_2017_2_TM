...
<body>
	...
	<div class="container">
		<div class="row">
			<h2 class="text-center text-info">REGISTRAR TORRE</h2>
			<div class="text-center" style="width: 60%;margin-left: auto;margin-right: auto;">
			<form method="Post" action="registrartorre.htm">
		...
		<h5 class="text-center text-danger">${mensaje}</h5>
	</div>
